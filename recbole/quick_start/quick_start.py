...
def run_recbole(
    ...
    #     "seq_len": {"item_id_list": 50},
    #     "load_col": {"inter": ["session_id", "item_id_list", "item_id"]},
    #     "alias_of_item_id": ["item_id_list"],
    # }
    config_dict = {}
    # python run_recbole.py --model=SASRec --train_neg_sample_args='None' --dataset=Amazon_Beauty_tmp
    config = Config(
        model=model,
        dataset=dataset,
    ...
    if config["model"] not in ["CoSeRec", "ICLRec"]:
    ...
    # model training
    best_valid_score, best_valid_result, _, _ = trainer.fit(
