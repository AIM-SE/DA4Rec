...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", "-d", type=str, default="Amazon_Sports_benchmark", help="name of datasets"
    )
    parser.add_argument(
        "--config_files", type=str, default="data_augmentation/configs/config_d_Amazon_Sports.yaml data_augmentation/configs/config_t_train.yaml data_augmentation/configs/config_m_SASRec.yaml", help="fixed config files"
    )
